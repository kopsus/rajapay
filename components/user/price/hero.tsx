export const HeroPrice = () => {
  return (
    <div className="relative h-94.5 w-full">
      ...
      <div className="relative flex flex-col justify-center gap-4 items-center text-center z-50 h-full">
        <p className="font-semibold text-primary text-5xl">Harga</p>
        <p className="text-[#4D5461]">List harga terbaik dan terupdate</p>
      </div>
    </div>
  );
};
